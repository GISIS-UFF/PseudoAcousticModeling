...
plt.viewModel(f"../outputs/estimated_models/fwi_epsilon_VTI_Nx301_Nz301_itr17_freq10.0.bin")
# plt.viewHistory()
...
# plt.viewSeismogram(f"../outputs/seismograms/seismogram_shot_5_Nt25001_Nrec100_fcut10.0.bin", perc=99)
...
plt.viewImage(f"/home/juanmarques/workspace/PseudoAcousticModeling/outputs/gradients/epsilon_gradient_fwi_iter_13_VTI_Nx301_Nz301_freq10.0.bin",laplacian=True,perc=99)
