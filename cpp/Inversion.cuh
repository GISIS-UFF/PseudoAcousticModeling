...
public:
    ...
    float zoom(const std::string& parameter, const float* model0, const float* grad0, const float* p, float X0, float gp0, float alpha_lo, float alpha_hi, float X_lo_initial, float& X_new, float* grad_new, float scale);
